  ...
  if (!connected) {
    return (
      <button
        ...
        disabled={connecting}
        className="flex items-center gap-2 bg-[#AB9FF2] hover:bg-[#AB9FF2]/90 text-white font-bold rounded-2xl px-4 py-2 text-sm transition-colors disabled:opacity-50"
      >
        {connecting ? (
